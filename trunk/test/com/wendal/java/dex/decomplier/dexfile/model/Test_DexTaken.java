...
public class Test_DexTaken {
    ...
    public void testGetDexClassList() throws IOException {
        ...
        file_list
                .add("dex/com/wendal/dex/simple/empty/EmptyInterface.dump.txt");
        file_list.add("dex/com/wendal/dex/simple/empty/EmptyEnum.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_Abstract.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_fields.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_final.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_SomeInterfaces.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_Static_fields.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/SimpleClass_with_SuperClass.dump.txt");
        file_list
                .add("dex/com/wendal/dex/simple/easy/methods/Void_String_Method.dump.txt");
        ...
        for (String string : file_list) {
            ...
            DexD dexD = new DexD(CommandLineConfig.parse(new String[] {
                    "-dest", "X:" }));
